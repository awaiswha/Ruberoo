      ...
      <div class="nav-bar-container">
          ...
          <div class="nav-bar-border">
              <p style="position: absolute;top:300px;color: #337ab7;right: 17px;margin-bottom:0px;">Home</p>
              <a href="{{url('/')}}" style="position: absolute;top: 315px;;color: #337ab7;right: 28px; "><i class="ion-home" style="font-size: 44px;"></i></a>
